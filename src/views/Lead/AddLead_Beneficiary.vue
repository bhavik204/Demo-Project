...
<div>
    ...
    <div class="wrapper">
      <div class="card">
       <div class="form-container">
         <div class="group">
         <text class="text" >Has Health Insurance</text>
        </div>
        <div class="group">
          <input class="input" type="tel" placeholder="Total Health"/>
        </div>
         <div class="group">
          <input class="input" type="tel" placeholder="Total Annual Premium"/>
        </div>
        <div class="group">
         <text class="text" >Has Term Insurance</text>
        </div>
        <div class="group">
          <input class="input" type="tel" placeholder="Total Life Cover"/>
        </div>
        <div class="group">
          <input class="input" type="tel" placeholder="Total Annual Premium"/>
        </div>
          <div class="group">
         <text class="text" >Has Motor Insurance</text>
        </div>
        <div class="group">
             <div class="card-btn">
           <text class="card-btn-text"  @click="addVehicle()">Add Vehicle</text>
    </div>
        </div>
    </div
    </div>
     ...
     <div class="card" v-if="childData ==true">
       <div class="form-container">
        ...
        <div class="card-line row" style="flex-directon:row">
          <div class="card-btn">
        <text class="card-btn-text" @click="listVehicle()">Submit</text>
     ...
     <div class="row">
          ...
          <div class="card-message" v-if="submit==true">
                ...
                <div class="card-line row">
                    <text class="card-subtitle shif-left table-header">Type</text>
                    <text class="card-subtitle shif-left table-header">Make</text>
                    <text class="card-subtitle shif-left table-header">Model</text>
                       <text class="card-subtitle shif-left table-header">Actions</text>
                </div>
          
                   <div v-for="(vehicles, index) in child">
                    <div class="card-line row h-border">
                      <text class="card-subtitle shif-left">{{vehicles.Type}} </text>
                      <text class="card-subtitle shif-left">{{vehicles.Make}}  </text>
                      <text class="card-subtitle shif-left amount-shift-left">{{vehicles.Model}}</text>
  ...
  <div clas="card">
      <div class="card-line row" style="flex-directon:row">
          <div class="card-btn-sub" @click="jump('/professional')">
...
<script>
  ...
  const items = ["Bike", "Car"];
  const gender = ["Ford", "Maruti Suzuki",
  "Chevrolet",
  "Tata",
  "BMW",
  "Mercedes",
