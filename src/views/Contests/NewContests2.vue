...
<script>
    ...
    import applicationTab from '../Application/ApplicationTab.vue'
  ...
  created() {
     ...
     computed: {
            getActiveStatus(){
                ...
                console.log(this.i)
                if(this.currentRoute == '/mastercontests/newcontests2/contests2_details')
                {
                ...
                if(this.currentRoute == '/mastercontests/newcontests2/contests2_elig')
                {
                    for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==1)
                        {
                ...
                if(this.currentRoute == '/mastercontests/newcontests2/contests2_rules')
                {
                    for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==2)
                        {
                ...
                if(this.currentRoute == '/mastercontests/newcontests2/contests2_rewards')
                {
                    for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==3)
                        {
                 ...
                 if(this.currentRoute == '/mastercontests/newcontests2/contests2_extras')
                {
                    for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==4)
                        {
       ...
       components:{mainTab,applicationTab , sideTab},
       data() {
         return {
               sTabs: [
                //    Digital East
                    {
                        Title: 'Details',
                        backgroundColor: '',
                        link: '/mastercontests/newcontests2/contests2_details'
                    ...
                    }, 
                    {
                        Title: 'Eligibility ',
                        backgroundColor: '',
                        link: '/mastercontests/newcontests2/contests2_elig'

                    },
                     {
                        Title: 'Rules',
                        backgroundColor: '',
                        link: '/mastercontests/newcontests2/contests2_rules'
                    },
                     {
                        link: '/mastercontests/newcontests2/contests2_rewards',
                        Title: 'Rewards',
                        backgroundColor: '',
                    },
                     {
                        Title: 'Extras',
                        link: '/mastercontests/newcontests2/contests2_extras',
                        backgroundColor: '',
                    },
