  ...
  created() {
     ...
     computed: {
            getActiveStatus(){
                ...
                console.log(this.i)
                if(this.currentRoute == '/mastercontests/newcontests5/contests5_details')
                {
                ...
                if(this.currentRoute == '/mastercontests/newcontests5/contests5_elig')
                {
                    for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==1)
                        {
                ...
                if(this.currentRoute == '/mastercontests/newcontests5/contests5_rules')
                {
                    for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==2)
                        {
                ...
                if(this.currentRoute == '/mastercontests/newcontests5/contests5_rewards')
                {
                    for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==3)
                        {
                 ...
                 if(this.currentRoute == '/mastercontests/newcontests5/contests5_extras')
                {
                    for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==4)
                        {
                ...
                //    Digital East
                    {
                        Title: 'Details',
                        backgroundColor: '',
                        link: '/mastercontests/newcontests5/contests5_details'
                    ...
                    }, 
                    {
                        Title: 'Eligibility ',
                        backgroundColor: '',
                        link: '/mastercontests/newcontests5/contests5_elig'

                    },
                     {
                        Title: 'Rules',
                        backgroundColor: '',
                        link: '/mastercontests/newcontests5/contests5_rules'
                    },
                     {
                        link: '/mastercontests/newcontests5/contests5_rewards',
                        Title: 'Rewards',
                        backgroundColor: '',
                    },
                     {
                        Title: 'Extras',
                        link: '/mastercontests/newcontests5/contests5_extras',
                        backgroundColor: '',
                    },
