<template>
    <div class="">
        <div class="protection-top-pad">
            <text class="protection-top-head-name">Protection Plans</text>
        </div>
        <div class="protection-master-flex-row">
...
<script>
    ...
    export default {
        created() {
            ...
            let self  =  this;
            this.GET('getproduct/?productType=protection', res => {
