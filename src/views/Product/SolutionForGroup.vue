<template>
    <div class="">
        <div class="protection-top-pad">
            <text class="protection-top-head-name">Employers Liability Solutions</text>
        </div>
        <div class="child-master-flex-row">
...
<script>
    ...
    export default {
        created() {
            ...
            let self  =  this;
            this.GET('getproduct/?productType=solutionforgroup', res => {
