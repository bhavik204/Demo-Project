<template>
    <div>
        ...
        <pop-up v-if="parentWindow === true">
            <div class="to-do-flx-row to-do-task-title">
                <div>
                    <text class="to-do-title-font">Join Club</text>
                </div>
                <div>
                    <image src="" class=""/>
                </div>
            ...
            <div class="todo-footer to-do-flx-row-rvrs">
                <div class="jcb-btn-lft-margin join-club-width">
                    <vx-primary-button
                        btn-name="Join Now"
            ...
            <pop-up>
                ...
                <div class="todo-body">
                    <div style="flex-direction:row;justify-content:center;padding:10px;">
                        <image src="https://www.materialui.co/materialIcons/action/check_circle_grey_192x192.png" class="jcb-leve-icon"/>
                    </div>
                    <div>
                        <text class="jcb-norml-fnt">Details of Digital East (1st to 30th June) has been shared with the selected 7 people via Email</text>
                    </div>
                </div>
            </pop-up>
        </div>
                ...
                <wxc-mask  
                        ...
                        <div class="content">
                            <div class="weex-overlay-header weex-overlay-task-title">
                                <div>
                                    <text class="weex-overlay-heading-font">Join Club</text>
                                </div>
                                <div>
                                    <image src="https://www.materialui.co/materialIcons/action/receipt_grey_192x19" class="rece-img-apkl" />
                                </div>
                            </div>
...
<script>
    ...
    import popupContent from '../../components/club/pop-up-content.vue'
        ...
        methods: {
            joinNowPopUp() {
                if(this.childPop === 0) {
                    ...
                    this.$emit('resetValue', this.parentWindow);
                    this.childPop = 1;
