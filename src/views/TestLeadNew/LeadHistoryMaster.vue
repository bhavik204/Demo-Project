<template>
    <div class="wrapper" style="background-color: #f7f7f7;">
            <div class="container-lead-master">
                <div>
        ...
        computed:{
            getActiveStatus(){
                ...
                console.log(this.status)
                  console.log(this.i)
  if(this.currentRoute == '/leadmasterpage/leadhistorymaster/leadhistory')
                  {
            ...
            this.sTabs[ind].borderBottomColor= '' 
              this.sTabs[ind].fontWeight = '';
                    ...
                    if(this.currentRoute == '/leadmasterpage/leadhistorymaster/leadhistorylead' )
                    {
                  for (let ind = 0; ind < this.sTabs.length; ind++) {
                        if(ind ==2)
                   {
         ...
         tabs: [
                    {
                        ...
                        borderBottomwidth: '',
                        borderBottomcolor: '',
                        link: '/leadmasterpage/leadhistorymaster/leadhistorylead'
                    }, {
                        Title: 'Issuance',
                        inactive: true,
                        active: false,
