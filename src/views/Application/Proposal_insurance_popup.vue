        ...
        <div class="card-propsal-fmly-popup">
            ...
            <div class="ld-cntc-dtls-flx-dir pd-rw-lft-rgt-10 prppsal-fmly-pad-tp-10">
                <div style="flex:1;" class="mbt-i-ld-20 mrgn-rw-fld-lft-rgt-10 ">
                    <div class="cra-evt-pd-btm-5"><text class="cntct-frm-lbl-size">Account With</text></div>
                    <div v-if="platform !== 'Web'" style="margin-bottom:20px">
                        <apk-drop-down :option-list="insuranceCoList"></apk-drop-down>
                    </div>
                    <div v-if="platform === 'Web'">
                        <select v-model="account_with" class="cursor-pointer-globle vx-globle-drp-down">
                            <option value="" selected>Select</option>
                            <option v-for="(calc, li) in insuranceCoList" :key="li">{{calc}}</option>
                        </select>
                    </div>
                </div>
                <div style="flex:1 " class="mbt-i-ld-20 mrgn-rw-fld-lft-rgt-10">
            ...
            <div class="ld-cntc-dtls-flx-dir pd-rw-lft-rgt-10">
                ...
                <div style="flex:1;" class="mbt-i-ld-20 mrgn-rw-fld-lft-rgt-10">
                    <div class=""><text class="cntct-frm-lbl-size">Policy Status</text></div>
                    <div v-if="platform !== 'Web'" style="margin-bottom:20px">
                        <apk-drop-down :option-list=" policystatus"></apk-drop-down>
                    </div>
                    <div v-if="platform === 'Web'">
                        <select v-model=" policystatus" class="cursor-pointer-globle vx-globle-drp-down">
                            <option value="" selected>Select</option>
                            <option v-for="(calc, li) in  policystatusWeb" :key="li">{{calc}}</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div v-if="platform !=='Web'" class=" contact-btn-space card-wrap-contactLead" style=" flex-direction:row;margin-bottom:10px;">
                <div class=" lead-contact-btn-width" style="padding:20px;">
                    <div class=" cursor-pointer-globle"  @click="jump('/master/testpro/proposalinsurance')">
                        <vx-secondary-button 
                            btn-name="Cancel" 
...
<script>
    ...
    var insuranceCoList = ['Aviva Life', 'Bajaj Allianz ','Bharti AXA','Birla Sun','Kotak Life','Reliance Life'];
    var policystatus = ['Applied','No Cash','Declined','Inforce','Lapsed','Postpone','Rated up','Rejected'];
