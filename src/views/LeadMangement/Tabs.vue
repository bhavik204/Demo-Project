<template>
    <div class="" >
        <scroller class="lead-scroller" scroll-direction="horizontal">
        <div class="tab-bar"> 
            <div  class="tabs-box" :style="{boxShadow: tabOne.shade, backgroundColor: tabOne.bgColor}" @click="activeTab(1)">
                <div class="tabs-content">
                    ...
                    <div>
                        <text class="tab-text large-text" :style="{color: tabOne.color}">{{tabOne.title | to-uppercase}}</text>
                    </div>
                </div>
                <div class="counter">
            ...
            <div  class="tabs-box" :style="{boxShadow: tabThree.shade, backgroundColor: tabThree.bgColor}" @click="activeTab(3)">
                <div class="tabs-content">
                    ...
                    <div>
                        <text class="tab-text large-text" :style="{color: tabThree.color}">{{tabThree.title | to-uppercase}}</text>
                    </div>
                </div>
                <div class="counter">
            ...
            <div  class="tabs-box" :style="{boxShadow: tabFour.shade, backgroundColor: tabFour.bgColor}" @click="activeTab(4)">
                <div class="tabs-content">
                    ...
                    <div>
                        <text class="tab-text large-text" :style="{color: tabFour.color}">{{tabFour.title | to-uppercase}}</text>
                    </div>
                </div>
                <div class="counter">
            ...
            <div  class="tabs-box" :style="{boxShadow: tabFive.shade, backgroundColor: tabFive.bgColor}" @click="activeTab(5)">
                <div class="tabs-content">
                    ...
                    <div>
                        <text class="tab-text large-text" :style="{color: tabFive.color}">{{tabFive.title | to-uppercase}}</text>
                    </div>
                </div>
                <div class="counter">
